...
APPLY_SMOOTHING = True  # Re-enabled: helps with noise
SMOOTHING_WINDOW = 3  # 3-day rolling mean for extreme noise

# Log transform - ENABLED (optimized for model accuracy)
# Note: Baseline adjustment is applied in predictor.py for recent trends
